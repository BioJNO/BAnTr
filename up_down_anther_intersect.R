# expr.dat <- read.csv("TranscriptomeResultsUpdate.csv")
...
# Exclude ncRNAs 
colnames(expr.dat)
print(levels(expr.dat$coding.noncoding))
coding <- subset(expr.dat, coding.noncoding =="coding")
...
upset(merged,
      ...
      queries = list(list(query = elements,
                          ...
                          color = "#bf812d", active = T),
                     list(query = elements,
                          params = list("coding.noncoding",
                                        c("undefined",
                                          "noncoding")),
                          color = "#f6e8c3", active = T),
                     list(query = elements,
                          params = list("coding.noncoding", 
                                        "noncoding"),
                          color = "#01665e", active = T)),
      text.scale = 4)
